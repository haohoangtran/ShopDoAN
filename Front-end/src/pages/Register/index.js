...
export default class Register extends Component {
    ...
    onRegiter() {
        if (!this.state.name) {
            this.setState({msg: "Tên không được để trống!", open: true});
        } else if (this.state.password.length < 8) {
            this.setState({msg: "Mật khẩu phải có ít nhất 8 ký tự", open: true});
        } else if (this.state.password !== this.state.repassword) {
            this.setState({msg: "Mật khẩu nhập lại không đúng", open: true});
        } else if (!this.validateEmail(this.state.email)) {
            this.setState({msg: "Email không hợp lệ", open: true});
        } else {
            fetch(`${CONFIG.BASE_URL}/register`, {
                ...
                .then((responseJson) => {
                    ...
                    if (responseJson.status) {
                        this.setState({msg: "Đăng ký thành công, vui lòng kiểm tra hộp thư của bạn!", open: true,isRegiter:true});
                    } else {
                        this.setState({msg: "Đăng ký thất bại, email đã được sử dụng!", open: true});
                    }
                })
                .catch((error) => {
                    console.error(error);
                    ...
                    <div>
                        ...
                        <div className="form-group">
                            ...
                            <input className="form-control" type="text" name="email" id="email"
                                   placeholder="james.bond@spectre.com" required
                        ...
                        <div className="m-t-lg">
                            ...
                            <li>
                                <a className="signup__link" href="http://localhost:3000">I am already a member</a>
                            </li>
                        </div>
                        <MuiThemeProvider>
                            <Dialog
